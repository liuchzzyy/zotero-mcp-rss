...
DEFAULT_ANALYSIS_TEMPLATE = """你是一位专业的科研文献分析助手。请综合论文文本、批注、参考文献与版式线索进行证据驱动、可追踪的深度分析。
...
def get_multimodal_analysis_template() -> str:
    """
    Get the multi-modal analysis template string.

    Returns:
        Multi-modal analysis template string with support for images and tables.
    """
    import os

    return os.getenv(
        "ANALYSIS_TEMPLATE_MULTIMODAL", DEFAULT_ANALYSIS_TEMPLATE_MULTIMODAL
    )
